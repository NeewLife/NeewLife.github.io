...
```
  ...
  <div id="df-5b465433-1f0b-40b6-93b6-6ceb58c9f8c3">
...
<table border="1" class="dataframe">
  ...
  <tbody>
    ...
    <tr>
      ...
      <button class="colab-df-convert" onclick="convertToInteractive('df-5b465433-1f0b-40b6-93b6-6ceb58c9f8c3')"
  ...
  <style>
    ...
    [theme=dark] .colab-df-convert:hover {
      ...
      <script>
        const buttonEl =
          document.querySelector('#df-5b465433-1f0b-40b6-93b6-6ceb58c9f8c3 button.colab-df-convert');
        buttonEl.style.display =
          google.colab.kernel.accessAllowed ? 'block' : 'none';

        async function convertToInteractive(key) {
          const element = document.querySelector('#df-5b465433-1f0b-40b6-93b6-6ceb58c9f8c3');
          const dataTable =
...
```
    ...
    <matplotlib.axes._subplots.AxesSubplot at 0x7f3c9eaae050>
...
```
    ...
    <matplotlib.axes._subplots.AxesSubplot at 0x7f3c9e973e10>
...
```
    ...
    <seaborn.axisgrid.FacetGrid at 0x7f3c9e934450>
...
```
    ...
    <seaborn.axisgrid.FacetGrid at 0x7f3c99fdbd10>
...
```
    ...
    <matplotlib.axes._subplots.AxesSubplot at 0x7f3c99fa8550>
...
```
    ...
    <matplotlib.axes._subplots.AxesSubplot at 0x7f3c99de3710>
...
```
    ...
    <matplotlib.axes._subplots.AxesSubplot at 0x7f3c99d3c0d0>
...
```
    ...
    <matplotlib.axes._subplots.AxesSubplot at 0x7f3c99ceb810>
...
```
    ...
    <matplotlib.axes._subplots.AxesSubplot at 0x7f3c99be36d0>
...
```
  ...
  <div id="df-003b4933-7699-47c8-80ce-d062890a8980">
    <div class="colab-df-container">
      <div>
<style scoped>
    .dataframe tbody tr th:only-of-type {
...
<table border="1" class="dataframe">
  ...
  <tbody>
    ...
    <tr>
      ...
      <button class="colab-df-convert" onclick="convertToInteractive('df-003b4933-7699-47c8-80ce-d062890a8980')"
              title="Convert this dataframe to an interactive table."
              style="display:none;">
  ...
  <style>
    ...
    [theme=dark] .colab-df-convert:hover {
      ...
      <script>
        const buttonEl =
          document.querySelector('#df-003b4933-7699-47c8-80ce-d062890a8980 button.colab-df-convert');
        buttonEl.style.display =
          google.colab.kernel.accessAllowed ? 'block' : 'none';

        async function convertToInteractive(key) {
          const element = document.querySelector('#df-003b4933-7699-47c8-80ce-d062890a8980');
          const dataTable =
            await google.colab.kernel.invokeFunction('convertToInteractive',
                                                     [key], {});
          if (!dataTable) return;
...
flights.pivot_table(flights, values = year, index=["year", "month", "passengers"])
```
    ...
    <ipython-input-25-68280ba6f5d6> in <module>()
          1 # flights['year'].value_counts()
    ----> 2 flights.pivot_table(flights, values = year, index=["year", "month", "passengers"])
...
```
    ...
    <ipython-input-26-58aedd0d3ebf> in <module>()
          1 # 회귀선
...
![png](/images/0706/output_29_1.png)
...
![png](/images/0706/output_30_1.png)
...
![png](/images/0706/output_34_1.png)
...
```
    ...
    <matplotlib.axes._subplots.AxesSubplot at 0x7f3c99987b90>




    
![png](/images/0706/output_39_1.png)
...
![png](/images/0706/output_48_0.png)
...
![png](/images/0706/output_50_0.png)
